...
```
    ...
    Selected newts: ['GCN15-P4-S4' 'GCN4-P4-S3']
...
```
    ...
    Newt 1 images: ['barhill/GCNs/GCN15-P4-S4/IMG_2987.JPEG'
     'barhill/GCNs/GCN15-P4-S4/IMG_2991.JPEG']
    Newt 2 images: ['barhill/GCNs/GCN4-P4-S3/IMG_2781.JPEG'
     'barhill/GCNs/GCN4-P4-S3/IMG_2782.JPEG']
...
![](00_attribution_files/figure-commonmark/cell-9-output-1.png)
...
```
    ...
    Performing occlusion sensitivity test for same newt...

![](00_attribution_files/figure-commonmark/cell-17-output-2.png)
...
```
    ...
    Performing MY occlusion sensitivity test for same newts...
    Processed 720/729 patches
    Completed occlusion testing - 729 patches processed.

![](00_attribution_files/figure-commonmark/cell-18-output-2.png)
...
```
    ...
    Performing occlusion sensitivity test for different newts...

![](00_attribution_files/figure-commonmark/cell-19-output-2.png)
...
```
    ...
    Performing MY occlusion sensitivity test for different newts...
    Processed 720/729 patches
    Completed occlusion testing - 729 patches processed.

![](00_attribution_files/figure-commonmark/cell-20-output-2.png)
...
```
    ...
    Performing Integrated Gradients for same newt (image1 vs image2)...

![](00_attribution_files/figure-commonmark/cell-23-output-2.png)


    Performing Integrated Gradients for different newts (newt A img1 vs newt B img1)...

![](00_attribution_files/figure-commonmark/cell-23-output-4.png)
...
```
    ...
    Performing Blur Perturbation for same newt (image1 vs image2)...
    Starting blur perturbation: 289 patches to process...
    Processed 289/289 patches...
    Completed blur perturbation.

![](00_attribution_files/figure-commonmark/cell-25-output-2.png)
...
![](00_attribution_files/figure-commonmark/cell-25-output-4.png)
